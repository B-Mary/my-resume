...
function calculateSum() {
   ...
   const websiteReception = document.querySelector('#calculator-form-input-rec input:checked');
  ...
  //  VALUE
   ...
   const websiteReceptionValue = convertRecOptionToPrice(websiteReception.value);
